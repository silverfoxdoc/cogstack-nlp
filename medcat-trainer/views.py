...
def save_models(request):
    ...
    elif project.model_pack is not None and project.model_pack.concept_db is not None:
        cdb_path = project.model_pack.concept_db.cdb_file.path
    else:
        return HttpResponseBadRequest('Project has no concept_db or model_pack configured')

    cat.cdb.save(cdb_path)
